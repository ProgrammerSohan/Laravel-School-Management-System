...
<head>
  <meta charset="utf-8">
    ...
    <title>Sohan Learning - Log in </title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{route('register')}}" style="color:white;" class="text-success ml-5">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
